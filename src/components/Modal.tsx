...
export default function Modal({ children, showModal, setShowModal }: { children: any;
  showModal: boolean;
  setShowModal: Dispatch<SetStateAction<boolean>>;
 }) {
  return (
    <>
    {showModal && <div className="absolute top-0 left-0 flex items-center justify-center h-screen -mt-12 overflow-hidden w-dvw">
